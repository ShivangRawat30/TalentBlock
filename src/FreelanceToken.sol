...
contract FreelanceToken is ERC20("FreelanceToken", "FT") {
    ...
    uint256 public constant maxSupply = 1000; // Maximum supply for each freelancer
    uint256 public constant initialTokenPrice = 10000000000; // Initial token price in USD
    uint256 public constant priceIncreaseThreshold = 100; // Number of tokens sold before price increase
    uint256 public constant priceIncreasePercentage = 20; // Percentage to increase price
    ...
    function createUser(string memory metaData) external {
